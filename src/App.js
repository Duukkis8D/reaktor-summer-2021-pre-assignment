  ...
  render() {
    return (
      ...
      <table>
        <thead>
          <tr>
            <th>id</th><th>product name</th><th>color</th><th>manufacturer</th><th>price</th><th>availability</th>
          </tr>
        </thead>
        <tbody>
          { this.state.jackets.map( jacket => <tr key={jacket.id}>
                                                <td key={jacket.id}>{jacket.id}</td>
                                                <td key={jacket.name}>{jacket.name}</td>
                                                <td key={jacket.color}>{jacket.color.map( color => 
                                                                          `${color} ` )}
                                                </td>
